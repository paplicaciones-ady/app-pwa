...
@Component({
      ...
      <div class="body">
        <div class="pmodal">
          ...
          <div class="in">
            ...
            <div class="tt"><span style="font-weight:700;color:var(--muted)">Total</span><span class="lab">\$0</span></div>
  ...
  styles: `
    ...
    .pmodal .img svg { width: 70px; height: 70px; }
    .pmodal .in { padding: 14px; }
    .pmodal .in h3 {
      font-size: 13px;
      font-weight: 800;
      color: var(--accent);
    ...
    .promo svg { width: 16px; height: 16px; color: var(--accent); }
